...
+ [PriorRG](https://arxiv.org/abs/2508.05353):**<font style="color:rgb(0,0,0);">Prior-Guided Contrastive Pre-training and Coarse-to-Fine Decoding for</font>****<font style="color:rgb(0,0,0);"> </font>****<font style="color:rgb(0,0,0);">Chest X-ray Report Generation</font>**
+ [CT2Rep](https://arxiv.org/abs/2403.06801)<font style="color:rgb(0,0,0);">:</font>**<font style="color:rgb(0,0,0);">Automated Radiology Report Generation for 3D Medical Imaging</font>**
+ [Dia-LLaMA](https://arxiv.org/abs/2403.16386)<font style="color:rgb(0,0,0);">: </font>**<font style="color:rgb(0,0,0);">Towards Large Language Model-driven CT Report Generation</font>**
+ [MvKeTR](https://arxiv.org/abs/2411.18309): **Chest CT Report Generation With Multi-View Perception and Knowledge Enhancement**
+ [Reg2RG](https://arxiv.org/abs/2411.15539):**Large Language Model With Region-Guided Referring and Grounding for CT Report Generation**
+ [A fully open AI foundation model applied to chest radiography](https://www.nature.com/articles/s41586-025-09079-8)
+ [MedVL-SAM2](https://arxiv.org/abs/2601.09879): **A unified 3D medical vision–language model for multimodal reasoning and prompt-driven segmentation**
+ [**The Landscape of Medical Agents: A Survey**](https://github.com/NUS-Project/Landmark-of-medical-agent)
...
### 2.4  进阶文献（医学视觉前沿方法）
+ [Self-Prompt SAM: ](https://arxiv.org/abs/2502.00630)**<font style="color:rgb(0,0,0);">Medical Image Segmentation via Automatic Prompt SAM Adaptation</font>**
+ [Large-vocabulary segmentation for medical images with text prompts](https://www.nature.com/articles/s41746-025-01964-w)
+ [MedITok: ](https://arxiv.org/abs/2505.19225)**A Unified Tokenizer for Medical Image Synthesis and Interpretation**
+ [A multi-modal vision-language model for generalizable annotation-free pathology localization](https://arxiv.org/abs/2401.02044)
+ [Agent Hospital](https://arxiv.org/abs/2405.02957): **A Simulacrum of Hospital with Evolvable Medical Agents**
+ [OmniMedVQA](https://arxiv.org/abs/2402.09181): **A New Large-Scale Comprehensive Evaluation Benchmark for Medical LVLM**
+ [HuatuoGPT-Vision](https://arxiv.org/abs/2406.19280):**Towards Injecting Medical Visual Knowledge into Multimodal LLMs at Scale**
+ [CardAIc-Agents](https://arxiv.org/abs/2508.13256): **A Multimodal Framework with Hierarchical Adaptation for Cardiac Care Support**
+ [PTB-XL]( https://doi.org/10.1038/s41597-020-0495-6): **a large publicly available electrocardiography dataset**
+ [MEDAGENTSBENCH](https://arxiv.org/abs/2503.07459): **Benchmarking Thinking Models and Agent Frameworks for Complex Medical Reasoning**
